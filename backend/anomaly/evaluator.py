...
Layers run L1 -> L2 -> L3 -> L4 -> L5. Each fired condition contributes its penalty to
...
from .layers.layer_3_behavioral import run_layer_3_behavioral
...
_LAYERS: list[tuple[LayerId, object]] = [
    ...
    ("L3_behavioral",  run_layer_3_behavioral),
